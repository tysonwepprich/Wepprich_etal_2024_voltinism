## Header ---------------------------
## Script name: utils.R
## Purpose of script: Small functions used in other scripts
...
# Population index estimated from weekly counts
# calculates an "area under the curve", interpreted as "butterfly-days" (not actual abundance) 
# when analyzing Pollard walks
...
AnnualPerc <- function(x, y1, y2){
  100*((((x / 100) + 1)^(1 / (y2 - y1))) - 1)
}
